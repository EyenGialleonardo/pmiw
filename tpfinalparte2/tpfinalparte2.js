...
function setup() {
  ...
  // Primero creamos el juego pero SIN pasar pantallas
  juego = new Juego(); 

  // Ahora creamos pantallas y le pasamos juego
  pantallas = new Pantallas(juego);

  // Finalmente, asignamos pantallas al juego
  juego.pantallas = pantallas;
}
